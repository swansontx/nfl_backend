"""Player play-by-play feature extraction
...
- Game context: score differential, game script, time remaining

Output: JSON file mapping player_id -> list of weekly features
"""
